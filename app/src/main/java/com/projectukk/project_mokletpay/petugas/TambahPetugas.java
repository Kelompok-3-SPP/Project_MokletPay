...
public class TambahPetugas extends AppCompatActivity {
    ...
    String idkelas;
    private EditText et_namapetugas, et_telp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_namapetugas= findViewById(R.id.et_namapetugas);
...
//        idkelas = i.getStringExtra("idkelas");
    ...
    private void ActionButton() {
        findViewById(R.id.text_simpan).setOnClickListener(view -> {
            if (koneksi.isConnected(TambahPetugas.this)) {
                TambahData();
            } else {
                CustomDialog.noInternet(TambahPetugas.this);
            }
        });
    }
    ...
    private void TambahData() {
        AndroidNetworking.get(Connection.CONNECT + "spp_petugas.php")
                ...
                .addQueryParameter("nama_petugas", et_namapetugas.getText().toString().trim())
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        successDialog(TambahPetugas.this, response.optString("pesan"));
                    }
                    ...
                    public void onError(ANError error) {
                        ...
                        if (error.getErrorCode() == 400) {
                            try {
                                ...
                                CustomDialog.errorDialog(TambahPetugas.this, body.optString("pesan"));
                            } catch (JSONException ignored) {
                            }
                        } else {
                            CustomDialog.errorDialog(TambahPetugas.this, "Sambunganmu dengan server terputus. Periksa sambungan internet, lalu coba lagi.");
                        }
                    }
                });
    }
    ...
    public void successDialog(final Context context, final String alertText) {
        ...
        inflater.findViewById(R.id.ok).setOnClickListener(v -> {
            Intent i = new Intent(TambahPetugas.this, ListPetugas.class);
