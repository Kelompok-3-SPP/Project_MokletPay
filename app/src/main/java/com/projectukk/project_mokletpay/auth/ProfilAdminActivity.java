...
public class ProfilAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        idadmin = i.getStringExtra("idadmin");
    ...
    private void actionButton() {
        ...
        findViewById(R.id.text_hapus).setOnClickListener(v -> {
            if (koneksi.isConnected(ProfilAdminActivity.this)){
                HapusData(idadmin);
            } else {
                CustomDialog.noInternet(ProfilAdminActivity.this);
            }
        });
    ...
    private void LoadData() {
        ...
        AndroidNetworking.get(Connection.CONNECT + "spp_akun.php")
                .addQueryParameter("TAG", "detail_admin")
                .addQueryParameter("idadmin", idadmin)
                    ...
                    public void onError(ANError error) {
                        ...
                        if (error.getErrorCode() == 400) {
                            try {
                                ...
                                CustomDialog.errorDialog(ProfilAdminActivity.this, body.optString("pesan"));
                            } catch (JSONException ignored) {
                            }
                        } else {
                            CustomDialog.errorDialog(ProfilAdminActivity.this, "Sambunganmu dengan server terputus. Periksa sambungan internet, lalu coba lagi.");
                        }
                    }
                });
    }

    private void HapusData(String idadmin) {
        customProgress.showProgress(this, false);
        AndroidNetworking.get(Connection.CONNECT + "spp_akun.php")
                .addQueryParameter("TAG", "hapus_admin")
                .addQueryParameter("idadmin", idadmin)
                .setPriority(Priority.MEDIUM)
                .build()
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        customProgress.hideProgress();
                        successDialog(ProfilAdminActivity.this, response.optString("pesan"));
                    }
